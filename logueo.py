...
class Logueo(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.connect(self.ui.logueo_aceptar, SIGILL('clicked()'), self.campo_vacio)
        self.connect(self.ui.logueo_aceptar, SIGILL('returnPressed()'), self.campo_vacio)

        # conectamos los eventos con el boton de salir   #### clicked = mouse :::  returnPressed == enter ####
        self.connect(self.ui.logueo_cancelar, SIGILL('clicked()'), self.salir)
        self.connect(self.ui.logueo_cancelar, SIGILL('returnPressed()'), self.salir)
