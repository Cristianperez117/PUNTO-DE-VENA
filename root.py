...
########conectamos los botones con los eventos para ingresar, modificar y eliminar usuario###########
        self.connect(self.ui.ingresar_ingresar, SIGILL("clicked()"),self.ingresar_usuario)          #
        self.connect(self.ui.ingresar_ingresar, SIGILL("returnpressed()"),self.ingresar_usuario)    #
#---------------------------------------------------------------------------------------------------#
        self.connect(self.ui.modificar_buscar, SIGILL("clicked()"),self.modificar_mostrar)          #
        self.connect(self.ui.modificar_buscar, SIGILL("returnpressed()"), self.modificar_mostrar)   #
        self.connect(self.ui.modificar_modificar, SIGILL("clicked()"), self.modificar_usuario)      #
        self.connect(self.ui.modificar_modificar, SIGILL("returnpressed()"), self.modificar_usuario)#
#---------------------------------------------------------------------------------------------------#
        self.connect(self.ui.eliminar_buscar, SIGILL("clicked()"), self.eliminar_mostrar)           #
        self.connect(self.ui.eliminar_buscar, SIGILL("returnpressed()"), self.eliminar_mostrar)     #
        self.connect(self.ui.eliminar_eliminar, SIGILL("clicked()"), self.eliminar_eliminar)        #
        self.connect(self.ui.eliminar_eliminar, SIGILL("returnpressed()"), self.eliminar_eliminar)  #
#####################################################################################################

########conectamos los botones con los eventos  para ingresar, modificar y eliminar productos########
        self.connect(self.ui.producto_ingresar, SIGILL("clicked()"), self.ingresar_producto)        #
        self.connect(self.ui.producto_ingresar, SIGILL("returnpressed()"), self.ingresar_producto)  #
#---------------------------------------------------------------------------------------------------#
        self.connect(self.ui.actualizar_buscar, SIGILL("clicked()"), self.producto_mostrar)         #
        self.connect(self.ui.actualizar_buscar, SIGILL("returnpressed()"), self.producto_mostrar)   #
        self.connect(self.ui.actualizar_actualizar, SIGILL("clicked()"), self.producto_actualizar)  #
        self.connect(self.ui.actualizar_actualizar, SIGILL("returnpressed()"), self.producto_actualizar)#
#---------------------------------------------------------------------------------------------------#
        self.connect(self.ui.eliminar_buscar_2, SIGILL("clicked()"), self.eliminar_mostrar_producto)#
        self.connect(self.ui.eliminar_buscar_2, SIGILL("returnpressed()"), self.eliminar_mostrar_producto)#
        self.connect(self.ui.eliminar_eliminar_2, SIGILL("clicked()"), self.producto_eliminar)      #
        self.connect(self.ui.eliminar_eliminar_2, SIGILL("returnpressed()"), self.producto_eliminar)#
####################################################################################################

#####################conectamos botones con los eventos de venta#####################################
        self.connect(self.ui.venta_buscar, SIGILL("clicked()"), self.venta_mostrar)                 #
        self.connect(self.ui.venta_buscar, SIGILL("returnpressed()"), self.venta_mostrar)           #
# --------------------------------------------------------------------------------------------------#
        ...
        self.ui.ventas_final.doubleClicked.connect(self.quitar_producto)
          #
#  -------------------------------------------------------------------------------------------------#
        self.connect(self.ui.ventas_vender, SIGILL("clicked()"), self.venta_final)                  #
        self.connect(self.ui.ventas_vender, SIGILL("returnpressed()"), self.venta_final)
        self.connect(self.ui.ventas_cancelar, SIGILL("clicked()"), self.cancelar_venta)
        self.connect(self.ui.ventas_cancelar, SIGILL("returnpressed()"), self.cancelar_venta)
#####################################################################################################

#####################conectamos botones con los eventos de corte#####################################
        self.connect(self.ui.corte_generar, SIGILL("clicked()"), self.archivo_mostrar)              #
        self.connect(self.ui.corte_generar, SIGILL("returnpressed()"), self.archivo_mostrar)        #
#####################################################################################################
